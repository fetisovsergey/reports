...
ActiveRecord::Schema.define(version: 20150424120804) do
  ...
  add_index "locations", ["latitude", "longtitude"], name: "index_locations_on_latitude_and_longtitude"
  add_index "locations", ["latitude"], name: "index_locations_on_latitude"
  add_index "locations", ["longtitude"], name: "index_locations_on_longtitude"
  ...
  add_index "microposts", ["address"], name: "index_microposts_on_address"
  add_index "microposts", ["latitude"], name: "index_microposts_on_latitude"
  add_index "microposts", ["longtitude"], name: "index_microposts_on_longtitude"
